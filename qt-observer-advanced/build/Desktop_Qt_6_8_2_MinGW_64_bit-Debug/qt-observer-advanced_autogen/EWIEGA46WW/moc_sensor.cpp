...
static constexpr auto qt_meta_stringdata_ZN6SensorE = QtMocHelpers::stringData(
    "Sensor",
    "dataUpdated",
    "",
    "TemperatureData",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6SensorE[] = {
...
Q_CONSTINIT const QMetaObject Sensor::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6SensorE.offsetsAndSizes,
    qt_meta_data_ZN6SensorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6SensorE_t,
        // Q_OBJECT / Q_GADGET
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dataUpdated((*reinterpret_cast< std::add_pointer_t<TemperatureData>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Sensor::*)(TemperatureData );
            if (_q_method_type _q_method = &Sensor::dataUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Sensor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6SensorE.stringdata0))
...
// SIGNAL 0
void Sensor::dataUpdated(TemperatureData _t1)
{
