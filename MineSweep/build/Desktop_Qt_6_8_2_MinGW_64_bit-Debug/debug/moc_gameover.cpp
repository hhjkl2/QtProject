...
namespace {
struct qt_meta_tag_ZN8GameOverE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8GameOverE = QtMocHelpers::stringData(
    "GameOver"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8GameOverE[] = {
...
Q_CONSTINIT const QMetaObject GameOver::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8GameOverE.offsetsAndSizes,
    qt_meta_data_ZN8GameOverE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8GameOverE_t,
        // Q_OBJECT / Q_GADGET
...
void *GameOver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8GameOverE.stringdata0))
