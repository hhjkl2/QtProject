...
static constexpr auto qt_meta_stringdata_ZN10BaseWidgetE = QtMocHelpers::stringData(
    "BaseWidget",
    "reapplyScaling",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10BaseWidgetE[] = {
...
Q_CONSTINIT const QMetaObject BaseWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10BaseWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10BaseWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10BaseWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BaseWidget, std::true_type>,
        // method 'reapplyScaling'
...
void BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->reapplyScaling(); break;
        default: ;
        }
    }
    (void)_a;
...
void *BaseWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10BaseWidgetE.stringdata0))
