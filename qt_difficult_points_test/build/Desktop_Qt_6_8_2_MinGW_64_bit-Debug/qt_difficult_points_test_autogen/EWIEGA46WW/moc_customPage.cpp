...
static constexpr auto qt_meta_stringdata_ZN10CustomPageE = QtMocHelpers::stringData(
    "CustomPage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10CustomPageE[] = {
...
Q_CONSTINIT const QMetaObject CustomPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10CustomPageE.offsetsAndSizes,
    qt_meta_data_ZN10CustomPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10CustomPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10CustomPageE.stringdata0))
