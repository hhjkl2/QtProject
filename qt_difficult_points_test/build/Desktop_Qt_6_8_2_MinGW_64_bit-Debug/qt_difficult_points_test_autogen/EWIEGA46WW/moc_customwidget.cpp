...
static constexpr auto qt_meta_stringdata_ZN12CustomWidgetE = QtMocHelpers::stringData(
    "CustomWidget",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CustomWidgetE[] = {
...
Q_CONSTINIT const QMetaObject CustomWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CustomWidgetE.offsetsAndSizes,
    qt_meta_data_ZN12CustomWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CustomWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CustomWidgetE.stringdata0))
